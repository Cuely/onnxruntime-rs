...
impl OnnxPrebuiltArchive for Triplet {
    fn as_onnx_str(&self) -> Cow<str> {
        match (&self.os, &self.arch, &self.accelerator) {
            // onnxruntime-win-x86-1.31.1.zip
            // onnxruntime-win-x64-1.31.1.zip
            // onnxruntime-win-arm-1.31.1.zip
            // onnxruntime-win-arm64-1.31.1.zip
            // onnxruntime-linux-x64-1.31.1.tgz
            // onnxruntime-osx-x64-1.31.1.tgz
            ...
            // onnxruntime-win-gpu-x64-1.31.1.zip
            ...
            // onnxruntime-linux-x64-gpu-1.31.1.tgz
